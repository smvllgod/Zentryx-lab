...
const links: Record<string, { label: string; href: string }[]> = {
  Product: [
    { label: "Visual Builder", href: "#" },
    { label: "Strategy Modules", href: "#" },
    { label: "MT5 Export", href: "#" },
  ...
  Company: [
    { label: "About", href: "#" },
    { label: "Careers", href: "#" },
    { label: "Contact", href: "mailto:hello@zentryx.studio" },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 md:gap-12">
          ...
          <div className="col-span-1 sm:col-span-2">
            ...
            <div className="flex gap-3 mt-6">
              {/* X (Twitter) */}
              <a href="#" className="w-9 h-9 rounded-xl border border-gray-200 flex items-center justify-center text-gray-400 hover:text-gray-700 hover:border-gray-300 transition-all">
