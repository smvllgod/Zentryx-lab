...
const emaCrossProEur: Template = {
  ...
  build: ({ strategyName }) => {
    ...
    const risk = nodeAt(2, 0, "risk.atrRisk", "risk", { riskPercent: 1, atrPeriod: 14, atrMultiplier: 1.5 }, "ATR risk 1%");
...
const donchianBreakout: Template = {
  ...
  build: ({ strategyName }) => {
    ...
    const risk = nodeAt(2, 0, "risk.atrRisk", "risk", { riskPercent: 1.5, atrPeriod: 14, atrMultiplier: 2 }, "ATR risk 1.5%");
...
const bollingerSqueezeBreak: Template = {
  ...
  build: ({ strategyName }) => {
    ...
    const newBar = nodeAt(1, 3, "utility.onlyNewBar", "utility", {});
    const risk = nodeAt(2, 0, "risk.atrRisk", "risk", { riskPercent: 1, atrPeriod: 14, atrMultiplier: 1 });
    const lot = nodeAt(2, 1, "lot.fromRisk", "lot", {});
...
const propFirmSafe: Template = {
  ...
  build: ({ strategyName }) => {
    ...
    const risk = nodeAt(2, 0, "risk.atrRisk", "risk", { riskPercent: 0.5, atrPeriod: 14, atrMultiplier: 1.5 }, "0.5% per trade");
    const lot = nodeAt(2, 1, "lot.fromRisk", "lot", {});
...
const multiTfMomentum: Template = {
  ...
  build: ({ strategyName }) => {
    ...
    const newBar = nodeAt(1, 2, "utility.onlyNewBar", "utility", {});
    const risk = nodeAt(2, 0, "risk.atrRisk", "risk", { riskPercent: 1, atrPeriod: 14, atrMultiplier: 1.5 });
    const lot = nodeAt(2, 1, "lot.fromRisk", "lot", {});
...
const goldTrendH4: Template = {
  ...
  build: ({ strategyName }) => {
    ...
    const risk = nodeAt(2, 0, "risk.atrRisk", "risk", { riskPercent: 1, atrPeriod: 14, atrMultiplier: 2 });
    const lot = nodeAt(2, 1, "lot.fromRisk", "lot", {});
...
const oneShotSniper: Template = {
  ...
  build: ({ strategyName }) => {
    ...
    const risk = nodeAt(2, 0, "risk.atrRisk", "risk", { riskPercent: 0.75, atrPeriod: 14, atrMultiplier: 1.5 });
    const lot = nodeAt(2, 1, "lot.fromRisk", "lot", {});
    const exit = nodeAt(3, 0, "exit.atrBased", "exit", { atrPeriod: 14, slMultiplier: 1.5, tpMultiplier: 3 });
    const be = nodeAt(3, 1, "manage.breakEvenAtrMulti", "management", { atrPeriod: 14, multiplier: 1 });
    return makeGraph({
